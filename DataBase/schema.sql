...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`users` (
  ...
  INDEX `fk_users_business_office1_idx` (`business_office_idoffice` ASC),
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`offices` (
  ...
  `type_of_contract_idtype_of_contract` INT NOT NULL,
  `road_types_roadType_id_roadType` INT NOT NULL,
  PRIMARY KEY (`idoffices`, `distribution_iddistribution`, `type_of_building_idtype_of_building`, `municipalities_idmunicipalities`, `type_of_contract_idtype_of_contract`, `road_types_roadType_id_roadType`),
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`locals_warehouses` (
  ...
  `type_of_contract_idtype_of_contract` INT NOT NULL,
  `road_types_roadType_id_roadType` INT NOT NULL,
  PRIMARY KEY (`idlocals_warehouses`, `location_idlocation`, `municipalities_idmunicipalities`, `type_of_contract_idtype_of_contract`, `road_types_roadType_id_roadType`),
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`garages` (
  ...
  `municipalities_idmunicipalities` INT NOT NULL,
  `road_types_roadType_id_roadType` INT NOT NULL,
  PRIMARY KEY (`idgarages`, `type_of_contract_idtype_of_contract`, `municipalities_idmunicipalities`, `road_types_roadType_id_roadType`),
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`floors_search_users` (
  ...
  INDEX `fk_floors_search_users_provinces1_idx` (`provinces_idprovinces` ASC),
  ...
  CONSTRAINT `fk_floors_search_users_users1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_floors_search_users_provinces1`
    FOREIGN KEY (`provinces_idprovinces`)
    REFERENCES `buscoPiso`.`provinces` (`idprovinces`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`offices_search_users` (
  ...
  `warehouse` TINYINT(1) NULL,
  `hot_water` TINYINT(1) NULL,
  `air_conditioner` TINYINT(1) NULL,
  `elevator` TINYINT(1) NULL,
  ...
  `type_of_contract_idtype_of_contract` INT NULL,
  `provinces_idprovinces` INT NOT NULL,
  `road_types_roadType_id_roadType` INT NULL,
  `users_users_id_user` INT NOT NULL,
  ...
  INDEX `fk_offices_search_users_provinces1_idx` (`provinces_idprovinces` ASC),
  INDEX `fk_offices_search_users_road_types1_idx` (`road_types_roadType_id_roadType` ASC),
  ...
  CONSTRAINT `fk_offices_search_users_users1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_offices_search_users_provinces1`
    FOREIGN KEY (`provinces_idprovinces`)
    REFERENCES `buscoPiso`.`provinces` (`idprovinces`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_offices_search_users_road_types1`
    FOREIGN KEY (`road_types_roadType_id_roadType`)
    REFERENCES `buscoPiso`.`road_types` (`roadType_id_roadType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`garages_search_users` (
  ...
  `price` DECIMAL NULL,
  `publication_date` DATE NULL,
  `motorcycle_seat` TINYINT(1) NULL,
  `automatic_door` TINYINT(1) NULL,
  `security` TINYINT(1) NULL,
  `type_of_contract_idtype_of_contract` INT NULL,
  `municipalities_idmunicipalities` INT NULL,
  `provinces_idprovinces` INT NOT NULL,
  ...
  INDEX `fk_garages_search_users_provinces1_idx` (`provinces_idprovinces` ASC),
  ...
  CONSTRAINT `fk_garages_search_users_users1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_garages_search_users_provinces1`
    FOREIGN KEY (`provinces_idprovinces`)
    REFERENCES `buscoPiso`.`provinces` (`idprovinces`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`locals_warehouses_search_users` (
  ...
  INDEX `fk_locals_warehouses_search_users_provinces1_idx` (`provinces_idprovinces` ASC),
  ...
  CONSTRAINT `fk_locals_warehouses_search_users_users1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_locals_warehouses_search_users_provinces1`
    FOREIGN KEY (`provinces_idprovinces`)
    REFERENCES `buscoPiso`.`provinces` (`idprovinces`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`lands_search_users` (
  ...
  INDEX `fk_lands_search_users_provinces1_idx` (`provinces_idprovinces` ASC),
  ...
  CONSTRAINT `fk_lands_search_users_users1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_lands_search_users_provinces1`
    FOREIGN KEY (`provinces_idprovinces`)
    REFERENCES `buscoPiso`.`provinces` (`idprovinces`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `buscoPiso`.`locals_warehouses_images` (
  `idlocals_warehouses_images` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  `locals_warehouses_idlocals_warehouses` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `buscoPiso`.`error_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buscoPiso`.`error_log` ;

CREATE TABLE IF NOT EXISTS `buscoPiso`.`error_log` (
  `iderror_log` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `buscoPiso`.`access_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `buscoPiso`.`access_log` ;

CREATE TABLE IF NOT EXISTS `buscoPiso`.`access_log` (
  `idaccess_log` INT NOT NULL AUTO_INCREMENT,
  `date` TIMESTAMP NOT NULL,
  `ip` VARCHAR(45) NULL,
