...
-- -----------------------------------------------------
-- Table `realState`.`additional_features_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `realState`.`additional_features_users` ;

CREATE TABLE IF NOT EXISTS `realState`.`additional_features_users` (
...
CREATE TABLE IF NOT EXISTS `realState`.`users` (
  ...
  CONSTRAINT `fk_users_business_office1`
    ...
    REFERENCES `realState`.`business_office` (`idoffice` , `municipalities_idmunicipalities`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_additional_features_users1`
    FOREIGN KEY (`additional_features_users_idadditional_features_users`)
    REFERENCES `realState`.`additional_features_users` (`idadditional_features_users`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
